    ...
    <>
      ...
      >
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link
            ...
            className="rounded-lg bg-yellow-300 px-6 py-3 text-center font-black text-slate-950 transition hover:bg-yellow-200"
          >
            Generate Content Pack
          </Link>
          <Link
            to="/design-services"
            className="rounded-lg border border-slate-700 px-6 py-3 text-center font-black text-white transition hover:border-yellow-300 hover:text-yellow-300"
          >
            Design Services
          </Link>
        </div>
      ...
      <section className="px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <Link
            to="/tools"
            className="mt-8 inline-flex rounded-lg border border-slate-700 px-5 py-3 font-bold text-white transition hover:border-yellow-300 hover:text-yellow-300"
          >
            View all tools
          </Link>
        </div>
      ...
      <section className="bg-slate-900 px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
          {[
            ...
            <div key={title} className="rounded-lg border border-slate-800 bg-slate-950 p-6">
